...
<div style="position:relative;width:1200px;height:700px;border-radius:10px;background-color:white;">
  ...
  $id=(mysql_real_escape_string(abs(intval($_GET['kitapno']))));
  $sorgu=mysql_query("select * from kitap where kitapno=$id");
  $goster=mysql_fetch_array($sorgu);
  echo "<center><img src=".$goster["kitap_resim"]." width=300 height=300 /></center>"."<br><br>";
  echo "<center>";
  echo "<b>ISBN No :</b>".$goster["isbnno"]."<br><br>";
  echo "<b>Kitap Adı :</b> ".$goster["kitapadi"]."<br><br>";
   echo "<b>Sayfa Sayısı :</b> ".$goster["sayfasayisi"]."<br><br>";
   echo "<b>Puanı :</b> ".$goster["puan"]."<br><br>";
    echo "<b>Yazar :</b> ".$goster["yazar"]."<br><br>";
	  echo "<b>Tür :</b> ".$goster["tur"]."<br><br>";
	  echo "</center>";
