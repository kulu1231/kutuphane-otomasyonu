  ...
  <div style="position:absolute;float:left;width:300px;height:700px;border-radius:10px;background-color:lightblue;">
    ...
    <form id="form2" name="form2" method="post" action="">
      <table width="862" height="384" border="0" cellpadding="0" cellspacing="10">
        ...
        <tr>
          <td>YAZAR</td>
          <td><input type="text" name="k6" id="textfield6" /></td>
        </tr>
       
        <tr>
          <td>TÜR:</td>
          <td><input type="text" name="k7" id="textfield7" /></td>
        </tr>
         <tr>
          <td></td>
	...
	$puan=$_POST["k4"];
	$kitap_resim=$_POST["k5"];
	$yazar=$_POST["k6"];
	$tur=$_POST["k7"];
	include("baglanti.php");
	
	if($kitapadi!=""and$sayfasayisi!=""and$isbnno!=""and$puan!=""and$kitap_resim!=""and$yazar!=""and$tur!="")
	{
 $ekle=mysql_query("insert into kitap(isbnno,kitapadi,sayfasayisi,puan,kitap_resim,yazar,tur)values('$isbnno','$kitapadi','$sayfasayisi','$puan','$kitap_resim','$yazar','$tur')");
	}
	else
	{
