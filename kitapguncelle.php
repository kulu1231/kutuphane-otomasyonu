...
<div style="position:relative;width:1200px;height:700px;border-radius:10px;background-color:white;">
 ...
 <hr />
  ...
  $listele=mysql_query("select * from kitap limit 8");
	  ...
	  echo '
	   <tr>
        ...
        <td>'.$tur.'</td>
		  ...
		  <td><a style=background-color:red;text-decoration:none;color:white;width:100px;height:30px;line-height:30px;text-align:center;border-radius:10px;display:block; href=kitapguncelle2.php?kitapno='.$ID.'>Düzenle</a></td>
